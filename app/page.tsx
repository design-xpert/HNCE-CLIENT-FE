...
export default function HomePage() {
  ...
  const handleHomeLead = (e: React.FormEvent) => {
    e.preventDefault();
                ...
                >
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-1.5">
                      ...
                      <Input id="lead-name" placeholder="Your full name" />
                    </div>
                    <div className="space-y-1.5">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-1.5">
                      ...
                      <Input id="lead-location" placeholder="e.g. Karnataka" />
                    </div>
                    <div className="space-y-1.5">
                      <Label htmlFor="lead-city">City</Label>
                      <Input id="lead-city" placeholder="e.g. Bangalore" />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-border p-4">
                    <Checkbox id="lead-captcha" />
                    <Label
                      htmlFor="lead-captcha"
